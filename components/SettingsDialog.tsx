...
interface SettingsDialogProps {
    ...
    cfGatewayUrl: string;
    setCfGatewayUrl: (val: string) => void;
    apiKey: string;
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            ...
            >
                ...
                <div className="p-5 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <option value="gptoss">GPT-OSS 120B (CF Gateway)</option>
                            </select>
                    ...
                    {/* GPT-OSS: Optional Gateway URL override */}
                    {provider === 'gptoss' && (
                        <div className="animate-in slide-in-from-top-2 duration-300">
                            <label className="block text-sm font-medium text-slate-300 mb-1.5">
                                Gateway URL
                                <span className="ml-1.5 text-slate-500 font-normal">(optional override)</span>
                            </label>
                            <input
                                type="text"
                                value={cfGatewayUrl}
                                ...
                                className="w-full bg-slate-800 border border-slate-700 text-white text-sm rounded-lg focus:ring-accent-500 focus:border-accent-500 block p-2.5 shadow-sm placeholder:text-slate-600"
                            />
                        </div>
                    )}

                    {/* API Key */}
                    {['openai', 'google', 'deepl', 'gptoss'].includes(provider) && (
                        <div className="animate-in slide-in-from-top-2 duration-300">
                            <label className="block text-sm font-medium text-slate-300 mb-1.5">
                                API Key
