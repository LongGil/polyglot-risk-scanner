    ...
    <header className="border-b border-slate-700 bg-slate-900/50 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          <div className="p-1.5 sm:p-2 bg-accent-600/10 rounded-lg border border-accent-600/20 flex-shrink-0">
            <Globe2 className="w-5 h-5 sm:w-6 sm:h-6 text-accent-500" />
          </div>
          <div className="min-w-0">
            <h1 className="text-base sm:text-xl font-bold text-white tracking-tight leading-tight">
              Polyglot <span className="text-accent-500">Risk Scanner</span>
            </h1>
            <p className="hidden sm:block text-xs text-slate-400 font-mono uppercase tracking-wider">Game Localization Toolset v1.0</p>
          </div>
        </div>
        <div className="flex items-center gap-2 flex-shrink-0">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 text-xs text-white bg-[#FF5E5B] hover:bg-[#ff4542] transition-colors px-2.5 sm:px-3 py-1.5 rounded-full border border-[#ff4542] font-medium"
          >
